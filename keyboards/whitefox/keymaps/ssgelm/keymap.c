...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT( \
        ...
        MO(2),  _______,_______,_______,_______,   CLIP,_______,_______,_______,_______,KC_SLCK,KC_PAUS,_______,        KC_PGUP,KC_VOLD,\
    ...
    [2] = LAYOUT( \
        ...
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,BL_TOGG,        BL_OFF ,\
