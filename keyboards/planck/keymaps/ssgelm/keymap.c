...
#define SLACK_UP LALT(LSFT(KC_UP))
#define SLACK_DOWN LALT(LSFT(KC_DOWN))
...
[_RAISE] = {
  ...
  {KC_LBRC, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, KC_RBRC},
  {_______, _______, _______, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY}
},
...
[_FUNCTION] = {
 ...
 {KC_LSFT, _______, _______, _______, _______, _______, _______, _______, BACK, _______, _______, FWD},
